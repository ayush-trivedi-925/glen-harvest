...
export default function AboutStory() {
  return (
    <Section tone="warm" className="flex items-center py-28">
      {/* Soft botanical wash */}
      <div className="absolute -left-40 top-10 h-[28rem] w-[28rem] rounded-[58%_42%_61%_39%] bg-moss/12 blur-3xl" />
      <div className="absolute -right-32 bottom-0 h-[26rem] w-[26rem] rounded-[42%_58%_39%_61%] bg-gold/15 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-6 md:px-8">
        <div className="grid gap-16 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          ...
          <div>
            ...
            <blockquote className="reveal mt-6 font-serif text-3xl font-medium leading-[1.25] text-forest text-balance md:text-4xl lg:text-[2.6rem]">
              &ldquo;We grew up watching makhana toasted in iron pans on quiet
              afternoons. It was never loud, never trendy — just present,
              patient, and good. We wanted to bottle that feeling and share
              it.&rdquo;
            </blockquote>
